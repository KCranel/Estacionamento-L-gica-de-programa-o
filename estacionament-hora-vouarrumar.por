programa
{
	...
	inclua biblioteca Texto --> txt
          ...
          enquanto (encerrar != 'F') {
               escolha (encerrar) {
                    caso 'E':
                         ...
                         pare
                    caso 'S':
                         saida(tipo, col, indis, disp, decisao, horaSaida, horaSub, hora)
                    caso 'T':
                         totCarros(decisao)
                    caso 'H':
                    	horas(decisao, hora)
     ...
     funcao saida(caracter tipo, inteiro col, caracter indis, caracter disp, caracter decisao, inteiro horaSaida, inteiro horaSub, inteiro hora)
     {
 ...
 * 
 * @POSICAO-CURSOR = 662; 
 * @DOBRAMENTO-CODIGO = [192, 211, 216, 243];
 * @PONTOS-DE-PARADA = ;
